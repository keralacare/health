...
const frames = [
  {
    id: "mission",
    title: "Our Mission",
    subtitle: "Building a Healthier Tamil Nadu",
...
export default function LaunchPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {phase === "frames" && (
          <>
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-full bg-linear-to-b from-white/20 via-white/5 to-transparent animate-beam-1" />
            <div className="absolute top-0 left-1/3 w-px h-full bg-linear-to-b from-white/10 via-white/5 to-transparent animate-beam-2" />
            <div className="absolute top-0 right-1/3 w-px h-full bg-linear-to-b from-white/10 via-white/5 to-transparent animate-beam-3" />
          </>
        )}
        <div className="absolute top-0 left-1/4 w-125 h-125 bg-emerald-500/10 rounded-full blur-[120px] animate-orbit" />
        <div className="absolute bottom-0 right-1/4 w-100 h-100 bg-teal-500/15 rounded-full blur-[100px] animate-orbit-reverse" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-cyan-500/10 rounded-full blur-[150px] animate-breathe" />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        {/* Tamil Nadu emblem with float animation */}
          ...
          <div className="text-center">
            ...
            >
              <div className="relative">
                <div className="absolute -inset-8 rounded-full bg-linear-to-r from-emerald-500/30 via-teal-500/30 to-cyan-500/30 blur-xl animate-spin-slow" />
                <div className="absolute -inset-4 rounded-full bg-linear-to-r from-cyan-500/20 via-emerald-500/20 to-teal-500/20 blur-lg animate-spin-slow-reverse" />
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-3 tracking-tight overflow-hidden">
              ...
              >
                <span className="bg-linear-to-r from-emerald-300 via-teal-200 to-cyan-300 bg-clip-text text-transparent animate-shimmer-text inline-block hover:scale-110 transition-transform">
                  Makkalai Thedi
                </span>
              </span>
              ...
              >
                <span className="bg-linear-to-r from-cyan-300 via-teal-200 to-emerald-300 bg-clip-text text-transparent animate-shimmer-text-reverse inline-block hover:scale-110 transition-transform">
                  Maruthuvam
                </span>
              </span>
            </h1>
            ...
            >
              <span className="animate-word-fade-1">Tamil Nadu&apos;s</span>{" "}
              <span className="animate-word-fade-2">NCD</span>{" "}
              <span className="animate-word-fade-3">&amp;</span>{" "}
              <span className="animate-word-fade-4">Cascade Care</span>{" "}
              <span className="animate-word-fade-5">Initiative</span>
            </p>
            ...
            {phase === "ready" && (
              ...
              >
                <div className="absolute -inset-1 bg-linear-to-r from-emerald-500 via-teal-400 to-cyan-500 rounded-2xl blur-lg opacity-80 group-hover:opacity-100 animate-pulse" />
                <div className="absolute inset-0 bg-linear-to-r from-emerald-600 via-teal-500 to-cyan-600 rounded-2xl" />
                <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/30 to-transparent rounded-2xl animate-shimmer-fast" />
        ...
        {phase === "countdown" && (
          <div className="text-center">
            <div className="relative">
              <div className="text-[160px] md:text-[240px] font-black text-transparent bg-linear-to-b from-emerald-300 via-teal-400 to-cyan-500 bg-clip-text animate-countdown-pop leading-none">
                {countdown}
              </div>
          ...
          <div key={frameKey} className="w-full max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <div
                  className={`relative w-28 h-28 md:w-36 md:h-36 rounded-3xl bg-linear-to-br ${currentFrameData.gradient} flex items-center justify-center shadow-2xl animate-icon-explode`}
                >
                  <currentFrameData.icon className="w-14 h-14 md:w-18 md:h-18 text-white animate-icon-breathe" />
                  <div
                    className={`absolute -inset-3 rounded-3xl bg-linear-to-br ${currentFrameData.gradient} opacity-40 blur-xl animate-pulse`}
                  />
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-black mb-2 overflow-hidden">
              <span
                className={`bg-linear-to-r ${currentFrameData.gradient} bg-clip-text text-transparent inline-block animate-title-reveal`}
              >
            ...
            {currentFrameData.tools && (
              <div className="flex justify-center gap-4 md:gap-6 mt-6">
                {currentFrameData.tools.map((tool, i) => (
                  ...
                  >
                    <div
                      className={`w-14 h-14 md:w-18 md:h-18 rounded-xl bg-linear-to-br ${tool.color} flex items-center justify-center shadow-lg animate-tool-bounce hover:scale-110 transition-transform cursor-pointer`}
            ...
            {currentFrameData.badges && (
              <div className="flex justify-center gap-3 mt-6">
                {currentFrameData.badges.map((badge, i) => (
                  <div
                    key={badge}
                    className={`bg-linear-to-r ${currentFrameData.gradient} rounded-full px-5 py-2 animate-badge-scale hover:scale-110 transition-transform cursor-pointer shadow-lg`}
                    style={{ animationDelay: `${i * 0.12}s` }}
                  >
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6">
              ...
              <div className="relative h-2 bg-white/10 rounded-full overflow-hidden backdrop-blur-sm">
                <div
                  className="absolute inset-y-0 left-0 bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-full transition-all duration-100 ease-linear"
        ...
        {phase === "final" && (
          <div className="fixed inset-0 flex items-end justify-center pb-20">
            ...
            <div className="relative animate-rocket-launch">
              ...
              <div className="w-36 h-36 md:w-48 md:h-48 rounded-full bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 flex items-center justify-center shadow-2xl shadow-emerald-500/60 mx-auto">
              ...
              <div className="absolute top-full mt-8 left-1/2 -translate-x-1/2 text-center whitespace-nowrap">
                ...
                <div className="flex justify-center gap-1.5 mt-4">
                  {[...Array(7)].map((_, i) => (
                    <div
                      key={i}
                      className="w-2.5 h-2.5 rounded-full bg-linear-to-r from-emerald-400 to-cyan-400 animate-bounce"
          ...
          <div className="text-center animate-celebration-zoom">
            <div className="relative mb-4">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-black">
                <span className="bg-linear-to-r from-yellow-300 via-emerald-300 to-purple-300 bg-clip-text text-transparent animate-rainbow">
                  🎉 LAUNCHED! 🎉
                </span>
              </h2>
            ...
            <p className="text-xl md:text-3xl text-emerald-200/90 mb-4 animate-bounce tracking-wide">
              Welcome to Makkalai Thedi Maruthuvam in Tamil Nadu
            </p>
      ...
      <style jsx>{`
        ...
        @keyframes shimmer-text-reverse {
          0%,
          100% {
            filter: brightness(1.4);
          }
        ...
        @keyframes text-glow {
          ...
          50% {
            text-shadow: 0 0 25px rgba(94, 234, 212, 0.7);
          }
        }
        ...
        .animate-sparkle-delay {
          animation: sparkle-delay 2s ease-in-out infinite 0.3s;
        }
        .animate-twinkle {
          animation: twinkle 2s ease-in-out infinite;
        }
        .animate-countdown-pop {
          animation: countdown-pop 0.35s ease-out forwards;
        }
        .animate-confetti {
          animation: confetti 3.5s ease-out forwards;
        }
        .animate-celebration-zoom {
          animation: celebration-zoom 0.5s ease-out forwards;
        }
        .animate-ping-fast {
          animation: ping-fast 1.2s ease-out forwards;
        }
        .animate-breathe {
          animation: breathe 4s ease-in-out infinite;
        }
        .animate-fade-zoom-out {
          animation: fade-zoom-out 1s ease-out forwards;
        }
        .animate-icon-explode {
          animation: icon-explode 0.5s ease-out forwards;
        }
        ...
        .animate-char-pop {
          animation: char-pop 0.4s ease-out both;
        }
        .animate-word-pop {
          animation: word-pop 0.3s ease-out both;
        }
        .animate-subtitle-slide {
          animation: subtitle-slide 0.4s ease-out 0.1s both;
        }
        .animate-tool-bounce {
          animation: tool-bounce 0.5s ease-out both;
        }
        .animate-fade-up {
          animation: fade-up 0.4s ease-out both;
        }
        .animate-feature-fly {
          animation: feature-fly 0.4s ease-out both;
        }
        .animate-check-pop {
          animation: check-pop 0.3s ease-out both;
        }
        .animate-badge-scale {
          animation: badge-scale 0.4s ease-out both;
        }
        .animate-final-burst {
          animation: final-burst 0.4s ease-out forwards;
        }
        .animate-shake {
        ...
        .animate-highlight-glow {
          animation: highlight-glow 0.4s ease-out forwards;
        }
        .animate-spark-1 {
          animation: spark-1 0.8s ease-out infinite;
        }
        .animate-spark-2 {
          animation: spark-2 0.9s ease-out infinite 0.1s;
        }
        .animate-spark-3 {
          animation: spark-3 1s ease-out infinite 0.2s;
        }
        .animate-spark-4 {
          animation: spark-4 1.1s ease-out infinite 0.3s;
        }
        .animate-shimmer-text {
          animation: shimmer-text 2s ease-in-out infinite;
        }
        .animate-shimmer-text-reverse {
          animation: shimmer-text-reverse 2s ease-in-out infinite;
        }
        .animate-text-glow {
        ...
        .animate-star-burst {
          animation: star-burst 0.4s ease-out both;
        }
        .animate-letter-bounce {
          animation: letter-bounce 1s ease-in-out infinite;
        }
        .animate-word-fade-1 {
          animation: word-fade-1 0.4s ease-out 0s both;
        }
        .animate-word-fade-2 {
          animation: word-fade-2 0.4s ease-out 0.1s both;
        }
        .animate-word-fade-3 {
          animation: word-fade-3 0.4s ease-out 0.2s both;
        }
        .animate-word-fade-4 {
          animation: word-fade-4 0.4s ease-out 0.3s both;
        }
        .animate-word-fade-5 {
          animation: word-fade-5 0.4s ease-out 0.4s both;
        }
        .animate-spin-slow {
        ...
        .animate-orbit-icon {
          animation: orbit-icon 4s linear infinite;
        }
        .animate-orbit-icon-reverse {
          animation: orbit-icon-reverse 6s linear infinite;
        }
        .animate-orbit-dot {
          animation: orbit-dot 3s linear infinite;
        }
        .animate-orbit-dot-reverse {
          animation: orbit-dot-reverse 5s linear infinite;
        }
        .animate-corner-tl {
          animation: corner-tl 0.5s ease-out forwards;
        }
        .animate-corner-tr {
          animation: corner-tr 0.5s ease-out 0.1s forwards;
        }
        .animate-corner-bl {
          animation: corner-bl 0.5s ease-out 0.2s forwards;
        }
        .animate-corner-br {
          animation: corner-br 0.5s ease-out 0.3s forwards;
        }
        .animate-slide-in-right {
          animation: slide-in-right 0.4s ease-out forwards;
        }
        .animate-number-pop {
          animation: number-pop 0.3s ease-out forwards;
        }
        .animate-grid-pulse {
        ...
        .animate-beam-2 {
          animation: beam-2 2.5s ease-in-out infinite 0.5s;
        }
        .animate-beam-3 {
          animation: beam-3 3s ease-in-out infinite 1s;
        }
        .animate-flame {
